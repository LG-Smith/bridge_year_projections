...
DT::datatable(table,
              caption = htmltools::tags$caption("* - Recreational Data for FY24 are not yet available",
  tags$br(),
...
Methods: Calendar 2024 catch data are scaled using the mean difference in catch from CY24 to CY25 over the period June 1st - July 24th.
